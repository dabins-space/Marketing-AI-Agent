...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const systemPrompt = `소상공인/스타트업을 위한 4가지 창의적이고 실행 가능한 마케팅 전략을 생성하세요. 각 전략은 단계별로 2-3개의 구체적인 액션을 포함해야 합니다:
...
전략 3: [창의적이고 구체적인 실행 아이디어 제목]
[동일 형식 - 각 단계별로 2-3개 액션]

전략 4: [창의적이고 구체적인 실행 아이디어 제목]
[동일 형식 - 각 단계별로 2-3개 액션]
...
function parseStrategyContent(content: string) {
  ...
  if (strategies.length === 0) {
    strategies.push(
      ...
      {
        title: '고객 스토리텔링 감성 마케팅',
        overview: '고객의 개인적인 스토리와 감정을 연결하여 브랜드와의 감정적 유대를 만드는 창의적 전략',
        reason: '고객과의 감정적 연결을 통한 마케팅 전략입니다. 고객의 개인적인 스토리와 브랜드를 연결하여 깊은 감정적 유대를 형성합니다. 스토리텔링을 통해 브랜드의 가치와 철학을 전달하고, 고객의 충성도를 높일 수 있습니다.',
        actions: [
          { title: '고객 스토리 수집을 위한 설문지 및 인터뷰 가이드 제작', duration: '1일', method: '직접 실행', section: 'preparation' },
          { title: '고객 스토리 수집 및 감동적인 에피소드 발굴', duration: '3일', method: '직접 실행', section: 'preparation' },
          { title: '고객 스토리를 담은 감성 콘텐츠 제작 (영상, 포스팅)', duration: '2일', method: '직접 실행', section: 'content' },
          { title: '고객 스토리 전용 인스타그램 하이라이트 및 해시태그 설정', duration: '1일', method: '직접 실행', section: 'content' },
          { title: '고객 스토리 기반 감성 이벤트 진행 및 공유 유도', duration: '7일', method: '직접 실행', section: 'execution' },
          { title: '고객 스토리 북 제작 및 매장 내 전시 및 배포', duration: '3일', method: '직접 실행', section: 'execution' }
        ],
        expectedEffect: '고객 충성도 60% 향상, 브랜드 인지도 2배 증가, 감정적 연결도 강화',
        requiredResources: '촬영 도구, 편집 소프트웨어, 인쇄물, 전시 공간'
      },
      {
        title: '지역 인플루언서 콜라보레이션 마케팅',
        overview: '지역 마이크로 인플루언서와 협업하여 신뢰도 높은 마케팅을 진행하는 창의적 전략',
        reason: '지역 밀착형 인플루언서 마케팅 전략입니다. 지역 마이크로 인플루언서와의 협업을 통해 타겟 고객에게 신뢰도 높은 마케팅을 전달합니다. 지역 커뮤니티 내에서의 입소문 효과와 브랜드 인지도 향상을 동시에 달성할 수 있습니다.',
        actions: [
          { title: '지역 마이크로 인플루언서 10명 발굴 및 연락처 수집', duration: '2일', method: '직접 실행', section: 'preparation' },
          { title: '인플루언서별 맞춤형 협업 제안서 작성 및 발송', duration: '1일', method: '직접 실행', section: 'preparation' },
          { title: '선정된 인플루언서 3명과 협업 콘텐츠 기획 및 제작', duration: '3일', method: '직접 실행', section: 'content' },
          { title: '인플루언서 콘텐츠 동시 발행 및 크로스 프로모션 진행', duration: '1일', method: '직접 실행', section: 'content' },
          { title: '인플루언서 팔로워 대상 특별 할인 쿠폰 제공', duration: '7일', method: '직접 실행', section: 'execution' },
          { title: '협업 성과 분석 및 후속 인플루언서 섭외 계획 수립', duration: '2일', method: '직접 실행', section: 'execution' }
        ],
        expectedEffect: '지역 인지도 3배 증가, 신규 고객 150명 유치, 브랜드 신뢰도 향상',
        requiredResources: '인플루언서 데이터베이스, 협업 예산, 할인 쿠폰, 분석 도구'
      }
    );
  }
